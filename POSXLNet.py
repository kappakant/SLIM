...
############################ Load the datasets ############################
training_preprocessed   = pd.read_csv(f'~/csvs/POS{n}train.csv')
testing_preprocessed    = pd.read_csv(f'~/csvs/POS{n}test.csv')
validation_preprocessed = pd.read_csv(f'~/csvs/POS{n}val.csv')
...
# %%
training_preprocessed['POS_words'][0]
...
word_count = count_words(training_preprocessed['POS_words'][0])
...
print('Original: ', training_preprocessed["POS_words"][0])

# Split the sentence into tokens - XLNet
print('Tokenized XLNet: ', xlnet_tokenizer.tokenize(training_preprocessed["POS_words"][0]))

# Mapping tokens to token IDs - XLNet
print('Token IDs XLNet: ', xlnet_tokenizer.convert_tokens_to_ids(xlnet_tokenizer.tokenize(training_preprocessed["POS_words"][0])))

# %%
#assigning merged information and labels to separate variables

POS_words = training_preprocessed["POS_words"].values
...
def xlnet_tokenization(dataset):
  POS_words = dataset["POS_words"].values
